...
describe(`GET ${PATH}`, () => {
  test('should successfully get a list of the LGAs', async () => {
  ...
  test('should get a list of LGAs with a valid json response', async () => {
    const response = await request(app)
      .get(PATH)
      .set('Authorization', `Bearer ${APIKey}`)
  ...
  test('should fail to get a list of the LGAs if API Key is not sent in the header', async () => {
